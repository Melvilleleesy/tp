...
public class AddressBookParserTest {
    ...
    public void parseCommand_delete() throws Exception {
        DeleteCommand command = (DeleteCommand) parser.parseCommand(
                DeleteCommand.COMMAND_WORD + " " + TypicalPersons.ALICE.getPhone());
        assertEquals(new DeleteCommand(TypicalPersons.ALICE.getPhone()), command);
    }
        ...
        assertEquals(
                new FindCommand(
                        new SearchPersonForKeyword(
                                Map.of(SearchPersonForKeyword.GENERAL_KEY, keywords))),
                command);
    }
